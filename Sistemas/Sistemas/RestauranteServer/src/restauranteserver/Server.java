...
public class Server implements IService {
    ...
    @Override
    public void setClienteServicio(int numero, String documento) throws RemoteException {
        Servicio s = gss.getServicioPorNumero(numero);
        Cliente c = gsc.getClientePorDoc(documento);
        if (c != null && s != null) {
            gss.setClienteServicio(s,c);
        }
    }
}
