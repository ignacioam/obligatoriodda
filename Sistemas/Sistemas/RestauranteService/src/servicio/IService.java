...
public interface IService extends Remote {
    ...
    boolean cerrarMesa(int numero) throws RemoteException;
    
    ArrayList<Servicio> obtenerServicios() throws RemoteException;

    void setClienteServicio(int numero, String documento) throws RemoteException;
}
